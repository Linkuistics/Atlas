...
fn overrides_yaml_golden_snapshot() {
    ...
    let file = OverridesFile {
        ...
        // Phase 3 PR-6: new top-level vectors default to empty in the
        // golden snapshot — `#[serde(default)]` keeps the on-disk
        // shape backwards-stable for golden-snapshot consumers.
        edges_add: Vec::new(),
