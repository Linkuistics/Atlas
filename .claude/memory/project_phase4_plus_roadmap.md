...
- **Phase 5** — *Next up.* Monorepo consolidation: fold atlas-contracts + Ravel + Ravel-Lite into Atlas; delete multi-root machinery. No design spec drafted yet (`docs/superpowers/specs/2026-05-*-atlas-vnext-phase5-design.md` not present); requires user-driven brainstorm via `superpowers:brainstorming`.
