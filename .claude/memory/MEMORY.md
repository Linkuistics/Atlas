...
- [Atlas vNext Phase 4+ roadmap](project_phase4_plus_roadmap.md) — Phases 4 + 5 + 6 SHIPPED; Phase 6 was final det-spine release; Phase 7 next (LLM-spine runtime per recast spec §11.1).
