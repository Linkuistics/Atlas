...
- [Atlas vNext Phase 4+ roadmap](project_phase4_plus_roadmap.md) — Phase 4 = cleanup release; consolidation early (Phase 5); polish + capability waves before subprocess + LLM frontier; server mode last (Phase 10).
...
- [Phase 6 brainstorm paused for LLM-spine recast](project_phase6_paused_for_llm_spine.md) — Phase 6 brainstorm reached PR-2 design before strategic pivot; four candidate items pre-analysed but not committed; LLM-spine brainstorm + §10 retext is next, Phase 6 resumes after.
