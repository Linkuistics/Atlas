...
- [Atlas vNext Phase 4+ roadmap](project_phase4_plus_roadmap.md) — Phases 4 + 5 + 6 + 7 SHIPPED; Phase 6 was final det-spine release; Phase 7 shipped LLM-spine runtime wiring (production prompts + Atlas-on-Atlas calibration deferred); Phase 8 next (Cargo retirement).
